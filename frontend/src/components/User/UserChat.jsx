...
const UserChat = () => {
    ...
    // Determine if web search should be shown
        ...
        <div className='flex flex-col h-screen bg-black text-white overflow-hidden'>
                    ...
                    {isProfileOpen && (
                        <div className="absolute top-12 right-0 w-64 bg-[#1e1e1e] rounded-xl shadow-lg border border-white/10 overflow-hidden z-30">
                            ...
                            <div className="py-1">
                                ...
                                <button className="w-full px-4 py-2.5 text-left flex items-center space-x-3 hover:bg-white/5 text-gray-300" onClick={() => navigate('/user/settings')}>
            ...
            <div className="flex-shrink-0 p-3 sm:p-4 bg-black">
                 <div className="w-full max-w-3xl mx-auto"> 
                    <ChatInput onSubmit={handleChatSubmit} showWebSearchIcon={showWebSearch} />
                 </div>
            </div>
